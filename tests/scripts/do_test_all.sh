...
declare -a tests=( "Flux_frc" "Pipes_ana" "Pipes_real" "Rivers_ana" "Rivers_real" "Filament" "CDR_3d" "CDR_dp" "CDR_parameterized" "bgc_real" )
# ******** USER INPUT END   ************
...
total=${#tests[*]}                            # total number of examples
...
#   break
  ...
  cd -                                         # need return out of / for next iteration
done
