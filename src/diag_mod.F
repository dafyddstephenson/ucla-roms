...
#endif
      integer, parameter :: max_check_line=512
...
#   endif
                Cu_Adv=buff(8)
                Cu_W=buff(9)
                i_cx_max=buff(10) +0.0001
                j_cx_max=buff(11) +0.0001
                k_cx_max=buff(12) +0.0001
              endif
#  else
              v2=buff(8)
...
c$$$  1   format(/,1X, A6, 2X, A10, 1X, A13, 1X, A13, 1X, A13, 1X, A13, 3X, A7, 1X, A7, 1X, A5, 1X, A12)
