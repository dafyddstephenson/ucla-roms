...
#endif
       use bgc_forces, only: pco2air, iron, dust
...
# endif
     ...
     &     * (c1 - DONrefract))
       ...
       DTRACER_MODULE(istr:iend,j,k,bgc_idx(iN2O)) = ammox * n2o_nh4_yield1 + 0.5 * DENITRIF2 - DENITRIF3

       DTRACER_MODULE(istr:iend,j,k,bgc_idx(iN2)) = DENITRIF3 + 0.5 * SED_DENITRIF + anammox
